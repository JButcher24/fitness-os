...
6. **The real goal is visible abs (~10% body fat), not just the 210 lb scale number.** 210 is a waypoint — his abs weight is likely lower (high 190s), muscle-dependent. Coach toward *composition* (body-fat trend, waist, muscle retained), and keep the lifting central since muscle decides how he looks at the finish. He's never had abs and wants them badly — that's the deep "why". Use it when motivation dips.
