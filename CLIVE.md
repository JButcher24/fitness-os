...
6. **The goal is visible abs (~10% body fat) — goal weight is now ~190 lb, not 210.** 210 is a milestone on the way ("15 stone"). The abs weight is provisional and muscle-dependent (likely 190–200 lb) — pin it from composition as he leans out. Coach toward *composition* (body-fat trend, waist, muscle retained), and keep the lifting central since muscle decides how he looks at the finish. He's never had abs and wants them badly — that's the deep "why". Use it when motivation dips.
