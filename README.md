...
- **`weighIns` composition fields** — optional `source`, `bodyFatPct`, `bmi`, `leanMassKg`, `note` per weigh-in (e.g. a smart-scale reading). The dashboard ignores them for the trend; they record what the scale actually reported.
